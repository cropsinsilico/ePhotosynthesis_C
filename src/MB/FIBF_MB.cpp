...
FIBFCondition* FIBF::_MB_con(const double t, const FIBFCondition* const FIBF_Con, Variables *theVars) {
    ...
    const double GPQH2_qb = theVars->FI_Vel.v3 - theVars->FI_Vel.v_r3 + theVars->FI_Vel.v3_n -
                            theVars->FI_Vel.v_r3_n;
    ...
    dydt->BF_con->PHs = - (theVars->HPR * theVars->BF_Vel.Vbf11 - Hrqb - Hvqi - theVars->BF_Vel.vbfn2) /
                        1000. / 0.015;  // PHs, The changes of PH in stoma, 0.03 mol /PH from Laisk et al.
