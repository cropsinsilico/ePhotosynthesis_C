...
namespace ePhotosynthesis {
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_BF, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_BF, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_BF, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_FI, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FI, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FI, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_PR, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PR, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PR, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_PS, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PS, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PS, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_VEL>::Type, std::string> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_VEL>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_VEL>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_VEL>::Type, std::vector<std::string>> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_VEL>::disabled_by_controls = {};
  template<>
