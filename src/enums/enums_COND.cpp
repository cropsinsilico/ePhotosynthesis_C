...
template<> 
const std::map<ValueSetEnum<MODULE_NONE, PARAM_TYPE_COND>::Type, std::string> ValueSetEnum<MODULE_NONE, PARAM_TYPE_COND>::docs = {
};
template<> 
std::map<ValueSetEnum<MODULE_NONE, PARAM_TYPE_COND>::Type, int> ValueSetEnum<MODULE_NONE, PARAM_TYPE_COND>::value_flags = {
};
template<> 
const std::map<ValueSetEnum<MODULE_NONE, PARAM_TYPE_COND>::Type, int> ValueSetEnum<MODULE_NONE, PARAM_TYPE_COND>::static_value_flags = {
};
...
template<> 
const std::map<ValueSetEnum<MODULE_MAX, PARAM_TYPE_COND>::Type, std::string> ValueSetEnum<MODULE_MAX, PARAM_TYPE_COND>::docs = {
};
template<> 
std::map<ValueSetEnum<MODULE_MAX, PARAM_TYPE_COND>::Type, int> ValueSetEnum<MODULE_MAX, PARAM_TYPE_COND>::value_flags = {
};
template<> 
const std::map<ValueSetEnum<MODULE_MAX, PARAM_TYPE_COND>::Type, int> ValueSetEnum<MODULE_MAX, PARAM_TYPE_COND>::static_value_flags = {
};
