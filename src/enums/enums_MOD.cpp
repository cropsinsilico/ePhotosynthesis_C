...
template<> 
const std::map<ValueSetEnum<MODULE_NONE, PARAM_TYPE_MOD>::Type, std::string> ValueSetEnum<MODULE_NONE, PARAM_TYPE_MOD>::docs = {
};
template<> 
std::map<ValueSetEnum<MODULE_NONE, PARAM_TYPE_MOD>::Type, int> ValueSetEnum<MODULE_NONE, PARAM_TYPE_MOD>::value_flags = {
};
template<> 
const std::map<ValueSetEnum<MODULE_NONE, PARAM_TYPE_MOD>::Type, int> ValueSetEnum<MODULE_NONE, PARAM_TYPE_MOD>::static_value_flags = {
};
...
template<> 
const std::map<ValueSetEnum<MODULE_MAX, PARAM_TYPE_MOD>::Type, std::string> ValueSetEnum<MODULE_MAX, PARAM_TYPE_MOD>::docs = {
};
template<> 
std::map<ValueSetEnum<MODULE_MAX, PARAM_TYPE_MOD>::Type, int> ValueSetEnum<MODULE_MAX, PARAM_TYPE_MOD>::value_flags = {
};
template<> 
const std::map<ValueSetEnum<MODULE_MAX, PARAM_TYPE_MOD>::Type, int> ValueSetEnum<MODULE_MAX, PARAM_TYPE_MOD>::static_value_flags = {
};
