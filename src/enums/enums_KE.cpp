...
namespace ePhotosynthesis {
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_BF, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FIBF, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_FI, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PR, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_PS, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::docs = {
    {ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::SCOPED_ENUM_TYPE(Type)KEe2ATPase, "2.177727336 was set in code, but not used"}
  };
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RROEA, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_RuACT, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_SUCS, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::Type, std::map<std::string, double>> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::alternate_defaults = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::units = {};
  template<>
  ...
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::Type, std::string> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::citations = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::required_modules = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::enabled_by_controls = {};
  template<>
  const std::map<typename ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::Type, std::vector<std::string>> ValueSetEnum<MODULE_XanCycle, PARAM_TYPE_KE>::disabled_by_controls = {};
  template<>
