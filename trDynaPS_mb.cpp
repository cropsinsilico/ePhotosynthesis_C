...
int trDynaPS::trDynaPS_mb(realtype t, N_Vector u, N_Vector u_dot, void *user_data) {
    ...
    //////WY201804
    const double Temp = RROEA_DYDT[8] - myVars->RROEA_Vel.ve2Fd + myVars->BF2RROEA_Vbf16 / myVars->AVR + myVars->RROEA_Vel.veFd2Calvin - myVars->BF2trDynaPS_vbfn2 - myVars->BF2TrDynaPSMB_vcet / myVars->AVR;
