...
void FI::FI_Rate(double t, FICon &FI_Con, Variables *theVars) {
    ...
    theVars->FI_Vel.vr2_1 = theVars->FI_Vel.vr2_00_1 + theVars->FI_Vel.vr2_01_1 + theVars->FI_Vel.vr2_02_1;//	vr2_1
