...
void PS::PS_Rate(const double t, const PSCon &PS_con, const arr &Param, Variables *theVars, const PRCon *PR_con) {
    ...
    if (theVars->useC3) {
        ...
        const double PsV1 = PsV1_0 * Ru_Act * pow(Q10_1, (theVars->Tp - 25) / 10);                     //   SHARED
        ...
        theVars->PS_Vel.v13 = PsV13 * (PS_con.ATP * Ru5P - ADP * PS_con.RuBP / KE13) / ((PS_con.ATP * (1 + ADP / KI134) + KM132*(1 + ADP / KI135)) * (Ru5P + KM131 * (1 + PS_con.PGA / KI131 + PS_con.RuBP / KI132 + theVars->Pi / KI133)));
        ...
        theVars->PS_Vel.v16 = std::min(theVars->beta * J, PsV16 * (ADP * theVars->Pi - PS_con.ATP / KE16)/(KM161 * KM162 * (1 + ADP / KM161 + theVars->Pi / KM162 + PS_con.ATP / KM163 + ADP * theVars->Pi /(KM161 * KM162))));

        theVars->PS2EPS_V16 = theVars->PS_Vel.v16;

        theVars->PS_Vel.v23 = PsV23 * G1P * PS_con.ATP /((G1P + KM231) * ((1 + ADP / KI23) * (PS_con.ATP + KM232) + (KM232 * theVars->Pi /(KA231 * PS_con.PGA + KA232 * F6P + KA233 * PS_con.FBP))));
        ...
        theVars->PS_Vel.v13 = PsV13 * (PS_con.ATP * Ru5P - ADP * PS_con.RuBP / KE13) / ((PS_con.ATP * (1 + ADP / KI134) + KM132 * (1 + ADP / KI135)) * (Ru5P + KM131 * (1 + PS_con.PGA / KI131 + PS_con.RuBP / KI132 + theVars->Pi / KI133)));
        theVars->PS_Vel.v16 = PsV16 * (ADP * theVars->Pi - PS_con.ATP / KE16) / (KM161 * KM162 * (1 + ADP / KM161 + theVars->Pi / KM162 + PS_con.ATP / KM163 + ADP * theVars->Pi / (KM161 * KM162)));
