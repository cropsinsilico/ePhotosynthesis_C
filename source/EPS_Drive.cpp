...
///////theVars->Sucs_Param = 0;
    ...
    theVars->PR_PS_com = 1;     // This is a variable indicating whether the PR model is actually need to be combined with PS or not. If 1 then means combined; 0 means not.
