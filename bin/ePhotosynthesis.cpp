...
int main(int argc, const char* argv[]) {
    try {
        ...
        options.add_options()
                ...
                ("x,species", "The species for the C4 model. Choices are:                  0 = Normol NADP-ME type                              1 = Asp+Mal transport and MDH type                   2 = Asp+Mal and PCK type                             3 = Asp+Mal and PCK+MDH type                         4 =  Asp and PCK only type                           6 = DiT2 mutant                                      7 = NAD-ME type                                      8 = NAD-ME+PCK type", cxxopts::value<uint>(species)->default_value("3"))
