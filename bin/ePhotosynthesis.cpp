...
int main(int argc, const char* argv[]) {
    try {
        ...
        options.add_options()
                ...
                ("x,species", "The species for the C4 model. Choices are:               1 - Maize                                            2 - sorghum                                          3 - sugarcane      ", cxxopts::value<uint>(species)->default_value("3"))
                ...
                ("w,pathway", "The pathway option to use for the C4 driver. Choices are:                                                      0 - Normol NADP-ME type                              1 - Asp+Mal transport and MDH type                   2 - Asp+Mal and PCK type                             3 - Asp+Mal and PCK+MDH type                         4 - Asp and PCK only type                            6 - DiT2 mutant                                      7 - NAD-ME type                                      8 - NAD-ME+PCK type", cxxopts::value<int>(pathway)->default_value("0"))
