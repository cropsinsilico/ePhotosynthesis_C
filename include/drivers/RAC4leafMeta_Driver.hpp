...
public:
    RAC4leafMetaDriver(Variables *theVars, const double startTime, const double stepSize, const double endTime,
...
private:
    ...
    /**
      ...
      */
    conditions::RAC4leafMetaCondition* RAC4leafMeta_Ini();
