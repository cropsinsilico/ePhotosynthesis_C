 ...
 */
class RuACTContainer : public ContainerBase<RuACTContainer, RAContainer> {
public:
    RuACTContainer(RAContainer *par = nullptr) {
        setParent(par);
    }
    /**
      ...
      */
    RuACTContainer(const RuACTContainer* other);
    ...
    /**
      ...
      */
    RuACTContainer(const arr vec, size_t offset = 0);
