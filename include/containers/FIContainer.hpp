 ...
 */
class FIContainer : public ContainerBase<FIContainer, FIBFContainer> {
public:
    FIContainer(FIBFContainer* par = nullptr) {
        setParent(par);
    }
    /**
      ...
      */
    FIContainer(const FIContainer* other);
    ...
    /**
      ...
      */
    FIContainer(const arr &vec, const size_t offset = 0);
