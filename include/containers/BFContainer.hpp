 ...
 */
class BFContainer : public ContainerBase<BFContainer, FIBFContainer> {
public:
    BFContainer(FIBFContainer* par = nullptr) {
        setParent(par);
    }
    /**
      ...
      */
    BFContainer(const BFContainer* other);
    /**
      ...
      */
    BFContainer(const arr &vec, const size_t offset = 0);
