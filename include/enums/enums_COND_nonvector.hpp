...
template<>
inline const std::vector<typename ValueSetEnum<MODULE_CM, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_CM, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_CM, PARAM_TYPE_COND>::nonvector;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_DynaPS, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_DynaPS, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_DynaPS, PARAM_TYPE_COND>::nonvector;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_EPS, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_EPS, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_EPS, PARAM_TYPE_COND>::nonvector;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_FIBF, PARAM_TYPE_COND>::nonvector;
}
template<>
...
template<>
inline const std::vector<typename ValueSetEnum<MODULE_PS_PR, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_PS_PR, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_PS_PR, PARAM_TYPE_COND>::nonvector;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_RA, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_RA, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_RA, PARAM_TYPE_COND>::nonvector;
}
template<>
...
template<>
inline const std::vector<typename ValueSetEnum<MODULE_trDynaPS, PARAM_TYPE_COND>::Type>& get_enum_nonvector<typename ValueSetEnum<MODULE_trDynaPS, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_trDynaPS, PARAM_TYPE_COND>::nonvector;
}
