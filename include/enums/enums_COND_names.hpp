...
template<>
inline const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_COND>::Type, std::string>& get_enum_names<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_COND>::Type>() {
...
template<>
inline const std::map<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_COND>::Type, std::string>& get_enum_names<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_PR, PARAM_TYPE_COND>::names;
}
template<>
...
inline const std::map<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_COND>::Type, std::string>& get_enum_names<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_RROEA, PARAM_TYPE_COND>::names;
}
template<>
inline const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_COND>::Type, std::string>& get_enum_names<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_COND>::names;
}
template<>
inline const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_COND>::Type, std::string>& get_enum_names<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_RuACT, PARAM_TYPE_COND>::names;
}
template<>
inline const std::map<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_COND>::Type, std::string>& get_enum_names<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_COND>::Type>() {
  return ValueSetEnum<MODULE_SUCS, PARAM_TYPE_COND>::names;
}
template<>
