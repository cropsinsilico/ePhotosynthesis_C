...
template<>
inline const std::vector<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_MOD>::Type>() {
...
template<>
inline const std::vector<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_MOD>::Type>() {
  return ValueSetEnum<MODULE_FI, PARAM_TYPE_MOD>::calculated;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_PR, PARAM_TYPE_MOD>::Type>() {
  return ValueSetEnum<MODULE_PR, PARAM_TYPE_MOD>::calculated;
}
template<>
...
inline const std::vector<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_RROEA, PARAM_TYPE_MOD>::Type>() {
  return ValueSetEnum<MODULE_RROEA, PARAM_TYPE_MOD>::calculated;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_MOD>::Type>() {
  return ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_MOD>::calculated;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_MOD>::Type>() {
  return ValueSetEnum<MODULE_RuACT, PARAM_TYPE_MOD>::calculated;
}
template<>
inline const std::vector<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_MOD>::Type>& get_enum_calculated<typename ValueSetEnum<MODULE_SUCS, PARAM_TYPE_MOD>::Type>() {
  return ValueSetEnum<MODULE_SUCS, PARAM_TYPE_MOD>::calculated;
}
template<>
