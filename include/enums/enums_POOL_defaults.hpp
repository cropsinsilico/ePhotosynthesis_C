...
template<>
inline const std::map<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_POOL>::Type, double>& get_enum_defaults<typename ValueSetEnum<MODULE_BF, PARAM_TYPE_POOL>::Type>() {
  return ValueSetEnum<MODULE_BF, PARAM_TYPE_POOL>::defaults;
}
template<>
inline const std::map<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_POOL>::Type, double>& get_enum_defaults<typename ValueSetEnum<MODULE_FIBF, PARAM_TYPE_POOL>::Type>() {
  return ValueSetEnum<MODULE_FIBF, PARAM_TYPE_POOL>::defaults;
}
template<>
inline const std::map<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_POOL>::Type, double>& get_enum_defaults<typename ValueSetEnum<MODULE_FI, PARAM_TYPE_POOL>::Type>() {
...
template<>
inline const std::map<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_POOL>::Type, double>& get_enum_defaults<typename ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_POOL>::Type>() {
  return ValueSetEnum<MODULE_RedoxReg, PARAM_TYPE_POOL>::defaults;
}
template<>
inline const std::map<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_POOL>::Type, double>& get_enum_defaults<typename ValueSetEnum<MODULE_RuACT, PARAM_TYPE_POOL>::Type>() {
  return ValueSetEnum<MODULE_RuACT, PARAM_TYPE_POOL>::defaults;
}
template<>
